...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_pull_requests_github_pr_number"),
        "pull_requests",
        ["github_pr_number"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "RUNNING", "SUCCESS", "FAILED", "CANCELLED", name="pipelinestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "stage_type",
            sa.Enum("LINT", "TEST", "SONARQUBE", "BUILD_IMAGE", "DEPLOY", name="stagetype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("PENDING", "RUNNING", "SUCCESS", "FAILED", "SKIPPED", name="stagestatus"),
            nullable=False,
        ),
